...
Filtern
 a| 
Begrenzungsereignisse, die durch die in das Feld eingegebenen Zeichen angezeigt werden. Verwenden Sie Anführungszeichen ("") für eine exakte Wortübereinkunft, geben Sie `OR` ein oder mehrere Wörter zurück oder geben Sie einen Bindestrich ( -- ) ein, um Wörter wegzulassen.
...
Spalten ein-/ausblenden
 a| 
Klicken Sie auf das Spaltensymbol *ein/Ausblenden*image:../media/sam-1140-ss-access-columns.gif[""], um zusätzliche Spalten für die Anzeige in der Tabelle auszuwählen. Weitere Spalten sind:
...
Spaltenfilter ein- oder ausschalten
 a| 
Klicken Sie auf das Symbol *Umschalten*image:../media/sam-1140-ss-access-toggle.gif[""], um Filterfelder für jede Spalte zu öffnen. Geben Sie in ein Spaltenfeld Zeichen ein, um die durch diese Zeichen angezeigten Ereignisse einzuschränken. Klicken Sie erneut auf das Symbol, um die Filterfelder zu schließen.
...
Änderungen rückgängig machen
 a| 
Klicken Sie auf das Symbol *Rückgängig*image:../media/sam-1140-ss-access-undo.gif[""], um die Tabelle auf die Standardkonfiguration zurückzusenden.
