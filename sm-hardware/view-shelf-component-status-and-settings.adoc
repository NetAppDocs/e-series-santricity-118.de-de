...
[NOTE]
====
Sie können diesen Status auch anzeigen, indem Sie das Netzteilsymbol image:../media/sam1130-ss-hardware-power-icon.gif[""]neben der Dropdown-Liste Regal auswählen.
...
[NOTE]
====
Sie können diesen Status auch anzeigen, indem Sie das Lüftersymbol image:../media/sam1130-ss-hardware-fan-icon.gif[""]neben der Dropdown-Liste Regal auswählen.
