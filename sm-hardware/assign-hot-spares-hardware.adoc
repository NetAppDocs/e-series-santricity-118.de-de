...
+
Wenn das Laufwerk sicher aktiviert ist, wird das Dialogfeld Secure Erase Drive? Angezeigt. Um ein sicheres Laufwerk als Hot Spare zu verwenden, müssen Sie zuerst einen Secure Erase-Vorgang durchführen, um alle Daten zu entfernen und die Sicherheitsattribute zurückzusetzen.
